...
ifeq ($(config),release_x64)
  ...
  OBJDIR = ../../build/obj/x64/Release/test_savedialog
  DEFINES += -DNDEBUG
...
ifeq ($(config),release_x86)
  ...
  TARGETDIR = ../../build/bin
  TARGET = $(TARGETDIR)/test_savedialog.exe
  OBJDIR = ../../build/obj/x86/Release/test_savedialog
  DEFINES += -DNDEBUG
  INCLUDES += -I../../src/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug_x64)
  ...
  OBJDIR = ../../build/obj/x64/Debug/test_savedialog
  DEFINES += -DDEBUG
  INCLUDES += -I../../src/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug_x86)
  ...
  TARGETDIR = ../../build/bin
  TARGET = $(TARGETDIR)/test_savedialog_d.exe
  OBJDIR = ../../build/obj/x86/Debug/test_savedialog
  DEFINES += -DDEBUG
  INCLUDES += -I../../src/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
